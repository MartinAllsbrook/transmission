...
export class BezierSplineExample {
    ...
    static demonstrateOperations(): void {
        ...
        curvePoints.forEach((point, index) => {
            ...
            console.log(`  t=${t.toFixed(2)}: (${point.x.toFixed(2)}, ${point.y.toFixed(2)})`);
        });
        ...
        for (let i = 0; i <= 4; i++) {
            ...
            console.log(`  t=${t.toFixed(2)}: (${derivative.x.toFixed(2)}, ${derivative.y.toFixed(2)})`);
        }
        ...
        console.log(`  Point: (${closest.point.x.toFixed(2)}, ${closest.point.y.toFixed(2)})`);
